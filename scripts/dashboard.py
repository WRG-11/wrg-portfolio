...
<div class="milestone-banner">
  ...
  <ul>
    <li>WRG MCP ecosystem live on 3 of 5 target distribution channels &#x2014; wrg-sigma-rules on Glama + awesome-mcp-servers, wrg-mcp-server on the MCP Registry</li>
...
_DISCLOSURE_CHAIN_HTML = """\
  <div class="info-card">
    <h3>&#x1F510; Active disclosure chain <span style="font-weight:400;color:#57606a;font-size:0.85em">(16-vendor convergent chain)</span></h3>
...
a sigma detection plugin (runtime TTP focus), submitted to the Anthropic Claude Code marketplace and live on Glama + awesome-mcp-servers. <strong>wrg-mcp-server</strong> is live on the MCP Registry. Across both packages the WRG MCP ecosystem covers 3 of 5
target distribution channels; Docker MCP Catalog <a href="https://github.com/docker/mcp-registry/pull/3836" style="color:inherit">PR #3836</a> open; Anthropic CC listing pending. Verified 2026-05-28.</p>
